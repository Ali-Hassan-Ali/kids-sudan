<x-dashboard.admin.layout.app>
    ...
    <x-slot name="title">
        {{ trans('admin.globle.home') . ' - ' . trans('admin.models.managements') . ' - ' . trans('admin.models.languages') }}
    </x-slot>
    ...
    <x-slot name="scripts">
        ...
        <script type="text/javascript">
        	$(function() {
        		...
        		let route = "{{ route('dashboard.admin.managements.languages.sortable.store') }}";
