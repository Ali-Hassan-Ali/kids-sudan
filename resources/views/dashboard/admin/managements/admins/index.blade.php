<x-dashboard.admin.layout.app>
    ...
    <x-slot name="title">{{ trans('admin.models.admins') }}</x-slot>

    <h2>{{ trans('admin.models.admins') }}</h2>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-md-12">
                        ...
                        @if(permissionAdmin('create-admins'))
                            <a href="{{ route('dashboard.admin.managements.admins.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> @lang('admin.global.create')</a>
                        @endif

                        @if(permissionAdmin('create-admins'))
                            <form method="post" action="{{ route('dashboard.admin.managements.admins.bulk_delete') }}" style="display: inline-block;">
                                @csrf
                                @method('delete')
