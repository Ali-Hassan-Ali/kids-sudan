<x-dashboard.admin.layout.app>
    ...
    <x-slot name="title">
        {{ trans('admin.models.websites') . ' - ' . trans('admin.models.services') }}
    </x-slot>
            ...
            <div class="tile shadow">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-md-12">
                        ...
                        @if(permissionAdmin('create-services'))
                            <a href="{{ route('dashboard.admin.websites.services.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> @lang('admin.global.create')</a>
                        @endif

                        @if(permissionAdmin('create-services'))
                            <form method="post" action="{{ route('dashboard.admin.websites.services.bulk_delete') }}" style="display: inline-block;">
                                @csrf
                                @method('delete')
